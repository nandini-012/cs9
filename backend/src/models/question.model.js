 ...
 *
 * Using one collection (instead of separate `faqs` + `questions`) keeps search,
 * moderation, voting, and notifications unified. Promotion of a community
 * question to an FAQ is just a `kind` flip.
 */

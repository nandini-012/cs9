...
export const RaiseQueryView: React.FC = () => {
  ...
  const handleSubmit = () => {
    if (!title || !description || !category) {
      alert('Please fill in Category, Title, and Description before submitting.')
      return
    }
    alert(`Query Submitted!\n\nTitle: ${title}\nCategory: ${category}\nAnonymous: ${isAnonymous ? 'Yes' : 'No'}`)
    setCategory(''); setTitle(''); setDescription(''); setAttachedFile(null); setIsAnonymous(false)
  }
        ...
        <div className="rq-layout">
          ...
          <div className="rq-form-col">
            ...
            <div className="form-group">
              ...
              <div
                ...
                onClick={() => document.getElementById('rq-file-upload')?.click()}
              >
                <input
                  type="file"
                  id="rq-file-upload"
            ...
            <div className="anon-box">
              ...
              <div
                ...
                style={{ background: isAnonymous ? '#0b1528' : '#d1d5db' }}
              ...
              >
                <div
                  ...
                  style={{ transform: isAnonymous ? 'translateX(16px)' : 'translateX(0)' }}
                />
              </div>
            </div>
            ...
            <div className="rq-actions">
              <button
                ...
                onClick={() => { setCategory(''); setTitle(''); setDescription(''); setAttachedFile(null); setIsAnonymous(false) }}
              >
                Discard Draft
              </button>
          ...
          <div className="rq-side-col">
            <div className="sim-queries-widget">
              ...
              <p className="sim-desc">We found queries similar to yours. Checking these might give you an instant answer.</p>
              {[
                { badge: 'resolved', badgeText: 'RESOLVED', title: 'Late grade submission for CMS102', desc: '"Is there a policy for when professors don\'t upload final grades..."' },
                { badge: 'progress', badgeText: 'IN PROGRESS', title: 'Portal error during course reg', desc: '"The portal keeps timing out when I try to add my elective..."' },
                { badge: 'resolved', badgeText: 'RESOLVED', title: 'Hostel Wi-Fi downtime in Block B', desc: '"The Wi-Fi on the second floor of Block B has been down for 3 days..."' },
              ].map((q, i) => (
                <div key={i} className="sim-card" style={{ cursor: 'pointer' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span className={`sim-badge ${q.badge}`}>{q.badgeText}</span>
            ...
            <div className="pro-tip">
              ...
              <div style={{ position: 'absolute', top: '-10px', right: '-10px', width: '50px', height: '50px', background: 'rgba(255,255,255,0.1)', borderRadius: '50%' }} />
              <div style={{ position: 'absolute', bottom: '-20px', right: '-20px', width: '80px', height: '80px', background: 'rgba(255,255,255,0.05)', borderRadius: '50%' }} />
            </div>
          </div>
        </div>
      </div>

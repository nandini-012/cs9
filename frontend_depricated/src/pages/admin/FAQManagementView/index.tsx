...
export const FAQManagementView: React.FC = () => {
  const [faqs, setFaqs] = useState<FAQ[]>([])
  const [loading, setLoading] = useState(true)
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false)
  const [currentFaq, setCurrentFaq] = useState<FAQ | null>(null)
  const [formData, setFormData] = useState({ category: 'Infrastructure', question: '', answer: '' })
          ...
          <div className="faqm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="faqm-modal-body">
              <div className="faqm-form-group">
                ...
                >
                  {['Infrastructure', 'Administration', 'Ethics', 'Admissions', 'General'].map((c) => (
